...
-- Copiando dados para a tabela shutdawndb.desenvolvedor: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela shutdawndb.papel: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela shutdawndb.squad: ~3 rows (aproximadamente)
